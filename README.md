...
If you imposed the
[CSP (Content Security Policy) Level 2](http://www.w3.org/TR/CSP/)
, you would see the CSP warnings. In order to avoid this you should assign
your nonce to `@content_security_policy_nonce` of your csp enabled controller.
It will be passed to the newrelic's script tags.
