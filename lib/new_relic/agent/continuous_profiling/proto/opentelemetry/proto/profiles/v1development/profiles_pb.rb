...
require_relative '../../../../opentelemetry/proto/resource/v1/resource_pb'
...
NewRelic::Agent::ContinuousProfiling::Proto::Registrar.register_once(pool, descriptor_data, 'opentelemetry.proto.profiles.v1development.ProfilesDictionary')
