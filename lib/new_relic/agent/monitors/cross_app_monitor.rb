    ...
    module DistributedTracing
      class CrossAppMonitor < InboundRequestMonitor
        ...
        def path_hash(txn_name, seed)
          ...
          format('%08x', rotated ^ hash_transaction_name(identifier))
        end
        ...
        def referring_transaction_info(_state, request_headers)
        ...
        def hash_transaction_name(identifier)
          Digest::MD5.digest(identifier).unpack1('@12N') & 0xffffffff
        end
      end
    end
  end
