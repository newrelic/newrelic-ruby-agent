    ...
    class Transaction
      class DistributedTracer
        ...
        def accept_incoming_transport_type(request, transport_type)
          @caller_transport_type = if transport_type.to_s == NewRelic::EMPTY_STR
                                     DistributedTraceTransportType.for_rack_request request
                                   else
                                     DistributedTraceTransportType.from transport_type
                                   end
        end
        ...
        def accept_cross_app_payload(headers, _tracer_state)
