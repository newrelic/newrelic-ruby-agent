  ...
  module Agent
    ...
    class Agent
      ...
      module InstanceMethods
        ...
        # If the @orker_thread encounters an error during the attempt to connect to the collector
        # then the connect attempts enter exponential backoff retry loop.  To avoid potential 
