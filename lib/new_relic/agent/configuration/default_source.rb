...
module NewRelic
  module Agent
    module Configuration
      ...
      class Boolean
        def self.===(o)
          o.is_a?(TrueClass) or o.is_a?(FalseClass)
        end
      end
      ...
      class DefaultSource
        ...
        def self.framework
          proc do
            if defined?(::NewRelic::TEST) then :test
            ...
            elsif defined?(::Sinatra) && defined?(::Sinatra::Base) then :sinatra
            elsif defined?(::NewRelic::IA) then :external
            else
              :ruby
            end
          end
        ...
        def self.convert_to_list(value)
          ...
          when Array
            ...
            raise ArgumentError, "Config value '#{value}' couldn't be turned into a list."
          end
        end
        ...
        def self.convert_to_constant_list(raw_value)
          ...
          const_names.map! do |class_name|
            ...
            NewRelic::Agent.logger.warn("Ignoring unrecognized constant '#{class_name}' in #{raw_value}") unless const
      ...
      DEFAULTS = {
        ...
        disable_rake_instrumentation: {
          ...
          allowed_from_server: false,
          deprecated: true,
          description: deprecated_description(:'instrumentation.rake',
                                              'Enable or disable Rake instrumentation. Preferred key is `disable_rake`')
        },
        'rake.tasks': {
          default: [],
          public: true,
        ...
        disable_resque: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.resque',
        ...
        disable_dj: {
          ...
          type: Boolean,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.delayed_job',
        ...
        disable_sinatra: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.sinatra',
        ...
        disable_memcached: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.memcached',
        ...
        disable_memcache_client: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.memcache-client',
        ...
        disable_dalli: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.memcache',
  ...
  '
        ...
        disable_mongo: {
          ...
          dynamic_name: true,
          deprecated: true,
          description: deprecated_description(:'instrumentation.mongo',
        ...
        disable_redis: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.redis',
        ...
        disable_redis_instrumentation: {
          ...
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.redis',
                                              'Disables installation of Redis instrumentation. Standard key to use is disable_redis.')
        },
        ...
        disable_bunny: {
          ...
          dynamic_name: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.bunny',
        ...
        disable_curb: {
          ...
          dynamic_name: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.curb',
        ...
        disable_excon: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.excon',
        ...
        disable_httpclient: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.httpclient',
        ...
        disable_rack: {
          ...
          allowed_from_server: false,
          deprecated: true,
          description: deprecated_description(:'instrumentation.rack',
        ...
        disable_rack_urlmap: {
          ...
          allowed_from_server: false,
          deprecated: true,
          description: deprecated_description(:'instrumentation.rack_urlmap',
        ...
        disable_puma_rack: {
          ...
          allowed_from_server: false,
          deprecated: true,
          description: deprecated_description(:'instrumentation.puma_rack',
        ...
        disable_puma_rack_urlmap: {
          ...
          allowed_from_server: false,
          deprecated: true,
          description: deprecated_description(:'instrumentation.puma_rack_urlmap',
        ...
        disable_typhoeus: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.typhoeus',
        ...
        disable_httprb: {
          ...
          deprecated: true,
          allowed_from_server: false,
          description: deprecated_description(:'instrumentation.httprb',
