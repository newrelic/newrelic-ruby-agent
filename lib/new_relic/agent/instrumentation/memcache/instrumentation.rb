...
module NewRelic::Agent::Instrumentation
  module Memcache
    module Tracer
      ...
      def with_newrelic_tracing(operation, *args, &block)
      ...
      def server_for_key_with_newrelic_tracing
        yield.tap do |server|
          if txn = ::NewRelic::Agent::Tracer.current_transaction
            ...
            assign_instance_to(segment, server) if segment.is_a?(::NewRelic::Agent::Transaction::DatastoreSegment)
          end
      ...
      def get_multi_with_newrelic_tracing(method_name, &block)
      ...
      def send_multiget_with_newrelic_tracing(keys, &block)
        segment = ::NewRelic::Agent::Tracer.start_datastore_segment \
          product: MEMCACHED,
