    ...
    module Instrumentation
      module Bunny
        ...
        module Exchange
          ...
          def publish_with_tracing(_payload, opts = {}, &block)
        ...
        module Consumer
          ...
          def call_with_tracing(*args, &block)
            delivery_info, message_properties, = args
