    ...
    module Chain
      def self.instrument!
        ::Sinatra::Base.class_eval do
          ...
          alias_method :process_route_without_newrelic, :process_route
          alias_method :process_route, :process_route_with_newrelic
          ...
          alias_method :route_eval_without_newrelic, :route_eval
          alias_method :route_eval, :route_eval_with_newrelic
        end
      end
    end
        ...
        def self.instrument!
          ::Sinatra::Base.class_eval do
            class << self
              ...
              alias_method :build_without_newrelic, :build
              alias_method :build, :build_with_newrelic
            end
          end
        end
      end
