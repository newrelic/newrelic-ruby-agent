...
DependencyDetection.defer do
  ...
  executes do
    if ::NewRelic::Agent.config[:prepend_curb_instrumentation]
      if RUBY_VERSION < "2.1.0"
        ...
        Curl::Easy.prepend ::NewRelic::Agent::Instrumentation::CurbPrepend::EasyPrepend
        Curl::Multi.prepend ::NewRelic::Agent::Instrumentation::CurbPrepend::MultiPrepend
      end
    else
      class Curl::Easy
