  ...
  module Agent
    module Instrumentation
      class NotificationsSubscriber
        ...
        def self.subscribed?
          find_all_subscribers.find { |s| s.instance_variable_get(:@delegate).instance_of?(self) }
        end
        ...
        def self.find_all_subscribers
          ...
          instance_variable_names = %i[@subscribers @string_subscribers @other_subscribers]
          all_subscribers = []

          notifier = ActiveSupport::Notifications.notifier

          instance_variable_names.each do |name|
            next unless notifier.instance_variable_defined?(name)
        ...
        def self.subscribe(pattern)
          ActiveSupport::Notifications.subscribe(pattern, new) unless subscribed?
        end
