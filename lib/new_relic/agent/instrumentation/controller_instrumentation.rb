      ...
      module ControllerInstrumentation
        ...
        module ClassMethods
          ...
          def newrelic_ignore(specifiers={})
            NewRelic::Agent.record_api_supportability_metric(NewRelic::Agent.agent, :newrelic_ignore)
          ...
          def newrelic_ignore_apdex(specifiers={})
            NewRelic::Agent.record_api_supportability_metric(NewRelic::Agent.agent, :newrelic_ignore_apdex)
            newrelic_ignore_aspect(NR_IGNORE_APDEX_KEY, specifiers)
          end

          # @api public
          def newrelic_ignore_enduser(specifiers={})
            NewRelic::Agent.record_api_supportability_metric(NewRelic::Agent.agent, :newrelic_ignore_enduser)
          ...
          def add_transaction_tracer(method, options={})
            NewRelic::Agent.record_api_supportability_metric(NewRelic::Agent.agent, :add_transaction_tracer)
        ...
        def perform_action_with_newrelic_trace(*args, &block) #THREAD_LOCAL_ACCESS
          NewRelic::Agent.record_api_supportability_metric(NewRelic::Agent.agent, :perform_action_with_newrelic_trace)
