  ...
  executes do
    ...
    Redis::Client.class_eval do
      ...
      def call(*args, &block)
        ...
        segment = NewRelic::Agent::Transaction.start_datastore_segment NewRelic::Agent::Datastores::Redis::PRODUCT_NAME, operation
        begin
      ...
      def connect(*args, &block)
        segment = NewRelic::Agent::Transaction.start_datastore_segment NewRelic::Agent::Datastores::Redis::PRODUCT_NAME, NewRelic::Agent::Datastores::Redis::CONNECT
        begin
