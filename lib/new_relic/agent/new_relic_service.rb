  ...
  module Agent
    class NewRelicService
      ...
      def invoke_remote(method, payload = [], options = {})
        unallowed_methods = %i[metric_data error_data transaction_sample_data sql_trace_data profile_data analytic_event_data custom_event_data log_event_data error_event_data span_event_data]
        NewRelic::Agent.logger.debug('Skipping #invoke_remote for 8T batching and compression tests') if unallowed_methods.include?(method)
