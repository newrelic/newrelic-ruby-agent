...
namespace :newrelic do
  namespace :config do
    ...
    SECTION_DESCRIPTIONS = {
      ...
      'ai_monitoring' => 'This section includes Ruby agent configurations for setting up AI monitoring. [Distributed tracing](/docs/apm/agents/ruby-agent/configuration/ruby-agent-configuration/#distributed-tracing) must be enabled to capture trace and feedback data. It is turned on by default in Ruby agents 8.0.0 and higher.'
    }
