...
- **Feature: Add Logging gem instrumentation**
  ...
  The agent will now record logs generated by [Logging gem](https://rubygems.org/gems/logging). [PR#3420](https://github.com/newrelic/newrelic-ruby-agent/pull/3420)
