    ...
    module SpanEventPrimitive
      class SpanEventPrimitiveTest < Minitest::Test
        ...
        def test_error_attributes_returns_populated_attributes_when_error_present
          segment, = capture_segment_with_error
        ...
        def test_includes_custom_attributes_in_event
          in_transaction do |txn|
            ...
            _, custom_attrs, = SpanEventPrimitive.for_segment txn.current_segment
        ...
        def test_doesnt_include_custom_attributes_in_event_when_configured_not_to
          with_config('span_events.attributes.enabled' => false) do
            with_segment do |segment|
              ...
              _, custom_attrs, = SpanEventPrimitive.for_segment segment
        ...
        def test_custom_attributes_in_event_cant_override_reserved_attributes
          with_segment do |segment|
            ...
            event, custom_attrs, = SpanEventPrimitive.for_segment segment
        ...
        def test_custom_span_attributes_not_added_to_transaction_events
          with_segment do |segment, _txn|
            ...
            _, custom_txn_attrs, = TransactionEventPrimitive.create payload

            _, custom_span_attrs, = SpanEventPrimitive.for_segment segment
        ...
        def test_attribute_exclusion
          ...
          _, optional_attrs, = last_span_events.detect { |ev| ev[0]['name'] == external_segment.name }
