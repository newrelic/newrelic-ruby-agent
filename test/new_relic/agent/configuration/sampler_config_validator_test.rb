...
module NewRelic::Agent::Configuration
  class SamplerConfigValidatorTest < Minitest::Test
    def setup
      ...
      # Reset the warning tracking between tests
    ...
    # Test validate_sampling_ratio method

    def test_validate_sampling_ratio_accepts_valid_float_in_range
    ...
    # Test parent strategy validation with valid ratios
    ...
    # Test parent strategy validation with invalid ratios
    ...
    # Test that other strategy values are not affected
    ...
    # Integration tests with actual config access
