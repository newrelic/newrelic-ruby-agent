  ...
  module Agent
    class TransactionEventPrimitiveTest < Minitest::Test
      ...
      def test_creates_intrinsics
        intrinsics, = TransactionEventPrimitive.create generate_payload
      ...
      def test_event_includes_synthetics
        ...
        intrinsics, = TransactionEventPrimitive.create payload
      ...
      def test_custom_attributes_in_event_are_normalized_to_string_keys
        ...
        _, custom_attributes, = TransactionEventPrimitive.create generate_payload('whatever')
      ...
      def test_error_is_included_in_event_data
        event_data, = TransactionEventPrimitive.create generate_payload('whatever', error: true)
      ...
      def test_includes_custom_attributes_in_event
        ...
        _, custom_attrs, = TransactionEventPrimitive.create generate_payload
      ...
      def test_custom_attributes_in_event_cant_override_reserved_attributes
        ...
        event, custom_attrs, = TransactionEventPrimitive.create generate_payload('whatever', metrics: metrics)
      ...
      def test_samples_on_transaction_finished_event_includes_expected_web_metrics
        ...
        event_data, = TransactionEventPrimitive.create generate_payload('name', metrics: txn_metrics)
      ...
      def test_samples_on_transaction_finished_event_include_apdex_perf_zone
        event_data, = TransactionEventPrimitive.create generate_payload('name', apdex_perf_zone: 'S')

        assert_equal 'S', event_data['nr.apdexPerfZone']
      end

      def test_samples_on_transaction_finished_event_includes_guid
        event_data, = TransactionEventPrimitive.create generate_payload('name', guid: 'GUID')
        assert_equal 'GUID', event_data['nr.guid']
      end

      def test_samples_on_transaction_finished_event_includes_referring_transaction_guid
        event_data, = TransactionEventPrimitive.create generate_payload('name',
                                                                        referring_transaction_guid: 'REFER')
