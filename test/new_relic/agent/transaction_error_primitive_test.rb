  ...
  module Agent
    class TransactionErrorPrimitiveTest < Minitest::Test
      ...
      def test_event_includes_expected_errors
        intrinsics, = create_event error_options: {
          expected: true
        }
      ...
      def test_event_includes_synthetics
        intrinsics, = create_event payload_options: {
      ...
      def test_includes_mapped_metrics
        ...
        intrinsics, = create_event payload_options: { metrics: metrics }
      ...
      def test_includes_cat_attributes
        intrinsics, = create_event payload_options: { guid: 'GUID',
                                                      referring_transaction_guid: 'REFERRING_GUID' }
      ...
      def test_includes_custom_attributes
        ...
        _, custom_attrs, = create_event error_options: { attributes: attributes }
