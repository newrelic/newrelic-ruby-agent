    ...
    class Transaction
      class DistributedTracingTest < Minitest::Test
        ...
        def test_sampled_flag_added_to_intrinsics_without_distributed_trace_when_true
          ...
          txn_intrinsics, = last_transaction_event
          err_intrinsics, = last_error_event
        ...
        def test_payload_ignored_when_nil
          in_transaction do |txn|
            refute txn.distributed_tracer.accept_distributed_trace_payload(nil)
          end
        ...
        def test_multiple_payload_accepts_ignored
          payload1 = create_distributed_trace_payload.text
          payload2 = create_distributed_trace_payload.text

          in_transaction do |txn|
            assert txn.distributed_tracer.accept_distributed_trace_payload(payload1)
            refute txn.distributed_tracer.accept_distributed_trace_payload(payload2)
          end
        ...
        def test_payload_rejected_when_accept_is_called_after_create
          payload = create_distributed_trace_payload.text
        ...
        def test_supportability_metric_recorded_on_major_version_mismatch
          ...
          in_transaction do |txn2|
            refute txn2.distributed_tracer.accept_distributed_trace_payload(payload.text)
          end
        ...
        def test_supportability_metric_recorded_accept_successful
          ...
          in_transaction do |txn|
            assert txn.distributed_tracer.accept_distributed_trace_payload(payload)
          end
        ...
        def create_distributed_transactions
          ...
          result[:grandparent_intrinsics], = last_transaction_event
          ...
          result[:parent_intrinsics], = last_transaction_event
          ...
          result[:child_intrinsics], = last_transaction_event
