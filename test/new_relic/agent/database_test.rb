...
class NewRelic::Agent::DatabaseTest < Minitest::Test
  ...
  def test_explain_sql_with_mysql2_activerecord_result
    ...
    explainer = ->(_statement) { activerecord_result }
  ...
  def test_explain_sql_select_with_mysql_explain_result
    ...
    explainer = ->(_statement) { explainer_result }
  ...
  def test_explain_sql_select_with_sequel
    ...
    explainer = ->(_statement) { plan_string }
  ...
  def test_explain_sql_select_with_sqlite_explain_string_result
    ...
    plan = [
      { 'addr' => 0, 'opcode' => 'Trace', 'p1' => 0, 'p2' => 0, 'p3' => 0, 'p4' => '', 'p5' => '00', 'comment' => nil, 0 => 0, 1 => 'Trace',
        2 => 0, 3 => 0, 4 => 0, 5 => '', 6 => '00', 7 => nil },
      { 'addr' => 1, 'opcode' => 'Goto',  'p1' => 0, 'p2' => 5, 'p3' => 0, 'p4' => '', 'p5' => '00', 'comment' => nil, 0 => 1, 1 => 'Goto',
        2 => 0, 3 => 5, 4 => 0, 5 => '', 6 => '00', 7 => nil },
      { 'addr' => 2, 'opcode' => 'String8', 'p1' => 0, 'p2' => 1, 'p3' => 0, 'p4' => 'foo', 'p5' => '00', 'comment' => nil, 0 => 2,
        1 => 'String8', 2 => 0, 3 => 1, 4 => 0, 5 => 'foo', 6 => '00', 7 => nil },
      { 'addr' => 3, 'opcode' => 'ResultRow', 'p1' => 1, 'p2' => 1, 'p3' => 0, 'p4' => '', 'p5' => '00', 'comment' => nil, 0 => 3,
        1 => 'ResultRow', 2 => 1, 3 => 1, 4 => 0, 5 => '', 6 => '00', 7 => nil },
      { 'addr' => 4, 'opcode' => 'Halt', 'p1' => 0, 'p2' => 0, 'p3' => 0, 'p4' => '', 'p5' => '00', 'comment' => nil, 0 => 4, 1 => 'Halt',
        2 => 0, 3 => 0, 4 => 0, 5 => '', 6 => '00', 7 => nil },
      { 'addr' => 5, 'opcode' => 'Goto', 'p1' => 0, 'p2' => 2, 'p3' => 0, 'p4' => '', 'p5' => '00', 'comment' => nil, 0 => 5, 1 => 'Goto',
        2 => 0, 3 => 2, 4 => 0, 5 => '', 6 => '00', 7 => nil }
    ]
    explainer = ->(_statement) { plan }
  ...
  def test_safe_sql_does_not_over_obfuscate_for_postgres
    ...
    conf = { adapter: 'postgresql', encoding: 'utf8', pool: 10, port: 5432, prepared_statements: false,
             ssl_mode: 'require' }
