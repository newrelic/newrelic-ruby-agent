  ...
  module Agent
    class AdaptiveSamplerTest < Minitest::Test
      def test_adaptive_sampler
        ...
        10_000.times { sampler.sampled? }
        stats = sampler.stats
        assert_equal 10, stats[:sampled_count]
        assert_equal 10_000, stats[:seen]
        advance_process_time(60)
        10_001.times { sampler.sampled? }
        stats = sampler.stats
        assert_equal 10_000, stats[:seen_last]
        assert_equal 10_001, stats[:seen]
      end
