...
class NewRelic::MetricDataTest < Test::Unit::TestCase
  ...
  def test_to_json_no_metric_id
    ...
    assert_equal('{"metric_spec":{"scope":"","name":"Custom/test/method"},"stats":{"total_exclusive_time":0.0,"min_call_time":0.0,"call_count":0,"sum_of_squares":0.0,"total_call_time":0.0,"max_call_time":0.0},"metric_id":null}', md.to_json, "should include the metric spec and have a null metric_id")
  end
