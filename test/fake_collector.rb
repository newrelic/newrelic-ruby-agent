...
if $0 == __FILE__
  ...
  class FakeCollectorTest < Test::Unit::TestCase
    ...
    def test_get_redirect
      ...
      assert_equal 'get_redirect_host', @collector.agent_data[0].method
    end
    ...
    def test_connect
      ...
      assert_equal 'connect', @collector.agent_data[0].method
    end
    ...
    def test_metric_data
      ...
      assert_equal 'metric_data', post.method
      assert_equal({'Foo/Bar' => [1,2,3], 'Baz/Cux' => [4,5,6]}, post.body)
      assert_equal 1, post.run_id
    end
