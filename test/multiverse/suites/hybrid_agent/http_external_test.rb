...
module NewRelic
  module Agent
    class HttpExternalTest < Minitest::Test
      ...
      def test_build_uri_with_all_components_v_1_17
        attributes = {
          'http.scheme' => 'http',
      ...
      def test_build_uri_defaults_to_root_path
        attributes = {
          'url.scheme' => 'https',
          'server.address' => 'example.com',
          'server.port' => 443
      ...
      def test_build_uri_falls_back_to_url_full_when_scheme_missing
        attributes = {
          'server.address' => 'example.com',
          'server.port' => 443,
          'url.path' => '/api',
      ...
      def test_build_uri_falls_back_to_http_url_when_host_missing
        attributes = {
          'url.scheme' => 'https',
          'server.port' => 443,
          'url.path' => '/api',
      ...
      def test_build_uri_falls_back_when_port_missing
        attributes = {
          'url.scheme' => 'https',
          'server.address' => 'example.com',
          'url.path' => '/api',
      ...
      def test_build_uri_prefers_url_scheme_over_http_scheme
        attributes = {
          'url.scheme' => 'https',
          'http.scheme' => 'http',
          'server.address' => 'example.com',
      ...
      def test_build_uri_prefers_server_address_over_net_peer_name
        attributes = {
          'url.scheme' => 'https',
      ...
      def test_build_uri_prefers_server_port_over_net_peer_port
        attributes = {
          'url.scheme' => 'https',
          'server.address' => 'example.com',
          'server.port' => 8443,
      ...
      def test_build_uri_prefers_url_path_over_http_target
        attributes = {
          'url.scheme' => 'https',
          'server.address' => 'example.com',
          'server.port' => 443,
      ...
      def test_build_uri_prefers_url_full_over_http_url
        attributes = {
