...
module MemcacheTestCases
  ...
  def test_noticed_error_at_segment_and_txn_on_error
    ...
    assert_segment_noticed_error txn, %r{Memcached/set$}, simulated_error_class.name, /No server available/i
