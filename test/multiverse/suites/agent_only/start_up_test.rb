...
class StartUpTest < Minitest::Test
  ...
  JRUBY_9000_NOISE = [
    %r{uri:classloader:/jruby/kernel/kernel\.rb:\d*: warning: unsupported exec option: close_others}, # https://github.com/jruby/jruby/issues/1913
    %r{.*/lib/ruby/stdlib/jar_dependencies.rb:\d*: warning: shadowing outer local variable - (group_id|artifact_id)}, # https://github.com/mkristian/jar-dependencies/commit/65c71261b1522f7b10fcb95de42ea4799de3a83a
